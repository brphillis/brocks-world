...
let playerBox = undefined;
let playerBoundingBox = undefined;
let arcadeMachineBox = undefined;
let arcadeMachineBoundingBox = undefined;
let gameState = false;
...
class BasicCharacterController {
  ...
  _LoadModels() {
    ...
    loader.setPath("./models/my-avatar/");
    ...
    roomLoader.load(
      "./models/objects/room/scene.gltf",
      (gltf) => {
    ...
    arcadeMachineLoader.load(
      "./models/objects/arcade-machine/scene.gltf",
      (gltf) => {
  ...
  Update(timeInSeconds) {
    ...
    function checkCollisions() {
      if (playerBoundingBox.intersectsBox(arcadeMachineBoundingBox)) {
        console.log("collision detected");
        console.log(playerBoundingBox.intersectsBox(arcadeMachineBoundingBox));
      }
    }
